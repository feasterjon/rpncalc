export const CONFIG = {
  ...
  input: {
    buttons: {
      ...
      styles: { // some styles are repeated to ensure they are applied onClick
        del: {
          active: 'bg-rpncalc-secondary border:rpncalc-secondary dark:bg-rpncalc-secondary-dark dark:border-rpncalc-secondary-dark',
          etc: 'border-2 border-rpncalc-secondary-light dark:hover:bg-rpncalc-secondary-dark dark:hover:border-rpncalc-secondary-dark dark:border-rpncalc-secondary hover:bg-rpncalc-secondary hover:border-rpncalc-secondary',
        ...
        enter: {
          ...
          etc: 'border-2 border-rpncalc-primary-light dark:border-rpncalc-primary dark:hover:bg-rpncalc-primary-dark dark:hover:border-rpncalc-primary-dark hover:bg-rpncalc-primary hover:border-rpncalc-primary',
        ...
        fn: {
          ...
          etc: 'border-2 border-neutral-200 dark:hover:bg-neutral-700 dark:border-neutral-800 hover:border-neutral-300 hover:bg-neutral-300 hover:dark:border-neutral-700'
        },
        main: {
          active: 'bg-neutral-300 border-neutral-300 dark:border-neutral-700 dark:bg-neutral-700',
          etc: 'border-2 border-neutral-200 dark:border-neutral-800 dark:hover:bg-neutral-700 hover:bg-neutral-300 hover:border-neutral-300 hover:dark:border-neutral-700',
          main: 'bg-neutral-200 dark:bg-neutral-800'
        },
        operator: {
          active: 'bg-rpncalc-primary border-rpncalc-primary',
          etc: 'border-2 border-rpncalc-primary-light dark:border-rpncalc-primary hover:bg-rpncalc-primary hover:border-rpncalc-primary'
        }
      }
    }
  },
